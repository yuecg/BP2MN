...
checkpoint = torch.load("../pretrained/uni-perceiver-superlarge-L24-H1024-224size-pretrained.pth",
...
torch.save(new_checkpoint,
           "../pretrained/uni-perceiver-superlarge-L24-H1024-224size-pretrained_converted.pth")
print("saved!")
